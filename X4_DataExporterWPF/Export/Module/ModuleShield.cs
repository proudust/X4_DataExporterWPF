...
namespace X4_DataExporterWPF.Export
{
    ...
    /// モジュールのシールド情報抽出用クラス
    /// </summary>
    public class ModuleShield : IExport
    {
        /// <summary>
        /// catファイルオブジェクト
        /// </summary>
        ...
        public ModuleShield(CatFile catFile, XDocument waresXml)
        {
            _CatFile = catFile;
            _WaresXml = waresXml;
        }
...
(
    ...
    FOREIGN KEY (SizeID)    REFERENCES Size(SizeID)
            ...
            ////////////////
            {
                ...
                cmd.CommandText = "INSERT INTO ModuleShield (ModuleID, SizeID, Amount) values (@moduleID, @sizeID, @amount)";
